...
async def stream_graph_responses(
    ...
    AGENT_STYLES = {
        'dbhub': {'color': 'cyan', 'emoji': '🔬', 'name': 'DB Assistant'},
        'kubernetes': {'color': 'magenta', 'emoji': '✍️', 'name': 'Kubernetes Assistant'},
        ...
        **kwargs
        ...
        if isinstance(message_chunk, AIMessageChunk):
            ...
            if namespace:
                ...
                if "call_dbhub" in namespace_str:
                    ai_source = "dbhub"
                elif "call_kubernetes" in namespace_str:
                    ai_source = "kubernetes"
                else:
